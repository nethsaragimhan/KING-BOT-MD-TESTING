...
module.exports = GojoMdNx = async (GojoMdNx, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            GojoMdNx.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴡʜɪᴛᴇ ʜᴀᴄᴋᴇʀꜱ`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./GojoMedia/logo.jpeg`),"sourceUrl": "https://telegra.ph/file/8bbe8a7de5c351dfcb077.jpg"}}}, { quoted: m})
        }
	...
	if (db.data.settings[botNumber].autobio) {
	  ...
	  //antilink\\
        ...
        if (isCreator) return reply(`Group Is Installed With Anti-Link But I Won't Kick You 😉, Because You Are My Owner Hahahahah🤣😘, You Think I Will Betray You Huh🇱🇰⃞`)
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let jodoh = member[Math.floor(Math.random() * member.length)]
            let jawab = `@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]} හත්තික්කේ ,  මොකෝ වෙන්නෙ ඉතින්😋`
...
case 'halah': case 'hilih': case 'huluh': case 'heleh': case 'holoh':
          ...
          reply(`Exif Has Been Successfully Changed to\n\n🇱🇰⃞ Packname : ${global.packname}\n🇱🇰⃞ Author : ${global.author}`)
            }
            break
	case 'kick': {
		if (!m.isGroup) return replay(`${mess.group}`)
		...
		reply('Broadcast Success')
            ...
            case 'chatinfo': case 'infochat': {
                ...
                for (let i of msg.userReceipt) {
                    ...
                    teks += `🇱🇰⃞ @${i.userJid.split('@')[0]}\n`
                    teks += ` ┗━🇱🇰⃞ *Time :* ${moment(waktu * 1000).format('DD/MM/YY HH:mm:ss')} 🇱🇰⃞ *Status :* ${read ? 'Read' : 'Sent'}\n\n`
                }
...
break
	    ...
	    case 'yts': case 'yt': case 'ytsearch': {
                ...
                for (let i of search.all) {
                    teks += `🇱🇰⃞ No : ${no++}\n🇱🇰⃞ Type : ${i.type}\n🇱🇰⃞ Video ID : ${i.videoId}\n🇱🇰⃞ Title : ${i.title}\n🇱🇰⃞ Views : ${i.views}\n🇱🇰⃞ Duration : ${i.timestamp}\n🇱🇰⃞ Uploaded On : ${i.ago}\n🇱🇰⃞ Author : ${i.author.name}\n🇱🇰⃞ Url : ${i.url}\n\n─────────────────\n\n`
                }
        ...
        case 'google': {
                ...
                for (let g of res) {
                teks += `🇱🇰⃞ *Title* : ${g.title}\n`
                teks += `🇱🇰⃞ *Description* : ${g.snippet}\n`
                teks += `🇱🇰⃞ *Link* : ${g.link}\n\n────────────────────────\n\n`
                } 
                reply(teks)
                })
        ...
        let buttons = [
                    {buttonId: `gimage ${text}`, buttonText: {displayText: '➡️Next Image️➡️'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: images },
...
💦️⃞ Url : ${anu.url}`,
            ...
            case 'song':{
                ...
                let buttons = [
                    ...
                    {buttonId: `ytmp3  ${anu.url}`, buttonText: {displayText: '🎲 MEDIUM QUALITY 🎲️'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: anu.thumbnail },
                    caption: `*╭───────────────╮*
	    ...
	    case 'ytmp3': case 'getmusic': case 'ytaudio': {
            ...
            case 'video':  {
                ...
                let buttons = [
                    ...
                    {buttonId: `dvideo  ${anu.url}`, buttonText: {displayText: '🎲 240P QUALITY 🎲️'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: anu.thumbnail },
                    caption: `*╭───────────────╮*
...
💠 Url : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
                ...
                GojoMdNx.sendMessage(m.chat, { image: { url: result }, caption: '🇱🇰⃞ Media Url : '+result }, { quoted: m })
            }
            break
case 'webtonsearch': case 'webtoon':
		...
		let buttons = [
                ...
                let buttonMessage = {
                    ...
                    caption: `🇱🇰⃞ Title : ${result.title}\n🇱🇰⃞ Category : ${result.type}\n🇱🇰⃞ Detail : ${result.source}\n🇱🇰⃞ Media Url : ${result.image[2] || result.image[1] || result.image[0]}`,
                    footer: GojoMdNx.user.name,
                    buttons: buttons,
                    headerType: 4
                }
		...
		let { wikimedia } = require('./lib/scraper')
                ...
                let buttonMessage = {
                    ...
                    caption: `🇱🇰⃞ Title : ${result.title}\n🇱🇰⃞ Source : ${result.source}\n🇱🇰⃞ Media Url : ${result.image}`,
                    footer: GojoMdNx.user.name,
                    buttons: buttons,
                    headerType: 4
                }
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
                ...
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Phone Number :* ${anu.message.nomer_hp}\n🇱🇰⃞ *Shuzi Angka Figures :* ${anu.message.angka_shuzi}\n🇱🇰⃞ *Positive Energy :*\n- Riches : ${anu.message.energi_positif.kekayaan}\n- Health : ${anu.message.energi_positif.kesehatan}\n- Love : ${anu.message.energi_positif.cinta}\n- Stability : ${anu.message.energi_positif.kestabilan}\n- Percentage : ${anu.message.energi_positif.persentase}\n🇱🇰⃞ *Negative Energy :*\n- Dispute : ${anu.message.energi_negatif.perselisihan}\n- Lost : ${anu.message.energi_negatif.kehilangan}\n- Catastrophe : ${anu.message.energi_negatif.malapetaka}\n- Destruction : ${anu.message.energi_negatif.kehancuran}\n- Percentage : ${anu.message.energi_negatif.persentase}`, m)
            }
            break
            case 'artimimpi': case 'tafsirmimpi': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Dream :* ${anu.message.mimpi}\n🇱🇰⃞ *Meaning :* ${anu.message.arti}\n🇱🇰⃞ *Solution :* ${anu.message.solusi}`, m)
            }
            break
            case 'ramalanjodoh': case 'ramaljodoh': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Your Name :* ${anu.message.nama_anda.nama}\n🇱🇰⃞ *Your Birth :* ${anu.message.nama_anda.tgl_lahir}\n🇱🇰⃞ *Couple Name :* ${anu.message.nama_pasangan.nama}\n🇱🇰⃞ *Born Couple :* ${anu.message.nama_pasangan.tgl_lahir}\n🇱🇰⃞ *Results :* ${anu.message.result}\n🇱🇰⃞ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'suamiistri': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Husband's Name :* ${anu.message.suami.nama}\n🇱🇰⃞ *Husband Born :* ${anu.message.suami.tgl_lahir}\n🇱🇰⃞ *Wife's Name :* ${anu.message.istri.nama}\n🇱🇰⃞ *Born Wife :* ${anu.message.istri.tgl_lahir}\n🇱🇰⃞ *Results :* ${anu.message.result}\n🇱🇰⃞ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'ramalancinta': case 'ramalcinta': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Your Name :* ${anu.message.nama_anda.nama}\n🇱🇰⃞ *Your Birth :* ${anu.message.nama_anda.tgl_lahir}\n🇱🇰⃞ *Couple Name :* ${anu.message.nama_pasangan.nama}\n🇱🇰⃞ *Born Couple :* ${anu.message.nama_pasangan.tgl_lahir}\n🇱🇰⃞ *Positive Side :* ${anu.message.sisi_positif}\n🇱🇰⃞ *Negative Side :* ${anu.message.sisi_negatif}\n🇱🇰⃞ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'artinama': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Name :* ${anu.message.nama}\n🇱🇰⃞ *Meaning :* ${anu.message.arti}\n🇱🇰⃞ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'kecocokannama': case 'cocoknama': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Name :* ${anu.message.nama}\n🇱🇰⃞ *Born :* ${anu.message.tgl_lahir}\n🇱🇰⃞ *Life Path :* ${anu.message.life_path}\n🇱🇰⃞ *Destiny :* ${anu.message.destiny}\n🇱🇰⃞ *Destiny Desire :* ${anu.message.destiny_desire}\n🇱🇰⃞ *Personality :* ${anu.message.personality}\n🇱🇰⃞ *Percentage :* ${anu.message.persentase_kecocokan}`, m)
            }
            break
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendImage(m.chat,  anu.message.gambar, `🇱🇰⃞ *Your Name :* ${anu.message.nama_anda}\n🇱🇰⃞ *Couple Name :* ${anu.message.nama_pasangan}\n🇱🇰⃞ *Positive Side :* ${anu.message.sisi_positif}\n🇱🇰⃞ *Negative Side :* ${anu.message.sisi_negatif}`, m)
            }
            break
            case 'jadianpernikahan': case 'jadiannikah': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Wedding Date :* ${anu.message.tanggal}\n🇱🇰⃞ *Characteristics :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Born :* ${anu.message.hari_lahir}\n🇱🇰⃞ *Business :* ${anu.message.usaha}`, m)
            }
            break
            case 'rejeki': case 'rezeki': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Born :* ${anu.message.hari_lahir}\n🇱🇰⃞ *Sustenance :* ${anu.message.rejeki}\n🇱🇰⃞ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'pekerjaan': case 'kerja': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Born :* ${anu.message.hari_lahir}\n🇱🇰⃞ *Profession :* ${anu.message.pekerjaan}\n🇱🇰⃞ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'ramalannasib': case 'ramalnasib': case 'nasib': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Analysis :* ${anu.message.analisa}\n🇱🇰⃞ *Root Number :* ${anu.message.angka_akar}\n🇱🇰⃞ *Nature :* ${anu.message.sifat}\n🇱🇰⃞ *Element :* ${anu.message.elemen}\n🇱🇰⃞ *Lucky Numbers :* ${anu.message.angka_keberuntungan}`, m)
            }
            break
            ...
            case 'artitarot': case 'tarot': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendImage(m.chat, anu.message.image, `🇱🇰⃞ *Born :* ${anu.message.tgl_lahir}\n🇱🇰⃞ *Tarot Symbol :* ${anu.message.simbol_tarot}\n🇱🇰⃞ *Meaning :* ${anu.message.arti}\n🇱🇰⃞ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Name :* ${anu.message.nama}\n🇱🇰⃞ *Born :* ${anu.message.tahun_lahir}\n🇱🇰⃞ *Gender :* ${anu.message.jenis_kelamin}\n🇱🇰⃞ *Kua Number :* ${anu.message.angka_kua}\n🇱🇰⃞ *Group :* ${anu.message.kelompok}\n🇱🇰⃞ *Character :* ${anu.message.karakter}\n🇱🇰⃞ *Good Sector :* ${anu.message.sektor_baik}\n🇱🇰⃞ *Bad Sector :* ${anu.message.sektor_buruk}`, m)
            }
            break
            case 'haribaik': {
                if (!text) throw `Example : ${prefix + command} 7, 7, 2005`
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Born :* ${anu.message.tgl_lahir}\n🇱🇰⃞ *When Challenged :* ${anu.message.kala_tinantang}\n🇱🇰⃞ *Info :* ${anu.message.info}\n🇱🇰⃞ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'harinaas': case 'harisial': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Day Of Birth :* ${anu.message.hari_lahir}\n🇱🇰⃞ *Date Of Birth :* ${anu.message.tgl_lahir}\n🇱🇰⃞ *Fateful Day :* ${anu.message.hari_naas}\n🇱🇰⃞ *Info :* ${anu.message.catatan}\n🇱🇰⃞ *Notes :* ${anu.message.info}`, m)
            }
            break
            case 'nagahari': case 'harinaga': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Day Of Birth :* ${anu.message.hari_lahir}\n🇱🇰⃞ *Date Of Birth :* ${anu.message.tgl_lahir}\n🇱🇰⃞ *Dragon Day Direction :* ${anu.message.arah_naga_hari}\n🇱🇰⃞ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'arahrejeki': case 'arahrezeki': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Day Of Birth :* ${anu.message.hari_lahir}\n🇱🇰⃞ *Date Of Birth :* ${anu.message.tgl_lahir}\n🇱🇰⃞ *Sustenance Direction :* ${anu.message.arah_rejeki}\n🇱🇰⃞ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'peruntungan': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Name :* ${anu.message.nama}\n🇱🇰⃞ *Born :* ${anu.message.tgl_lahir}\n🇱🇰⃞ *Fortune Of The Year :* ${anu.message.peruntungan_tahun}\n🇱🇰⃞ *Results :* ${anu.message.result}\n🇱🇰⃞ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'weton': case 'wetonjawa': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Date :* ${anu.message.tanggal}\n🇱🇰⃞ *Number Of Neptune :* ${anu.message.jumlah_neptu}\n🇱🇰⃞ *Day Character :* ${anu.message.watak_hari}\n🇱🇰⃞ *Dragon Day :* ${anu.message.naga_hari}\n🇱🇰⃞ *Good Hour :* ${anu.message.jam_baik}\n🇱🇰⃞ *Birth Character :* ${anu.message.watak_kelahiran}`, m)
            }
            break
            case 'sifat': case 'karakter': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Name :* ${anu.message.nama}\n🇱🇰⃞ *Born :* ${anu.message.tgl_lahir}\n🇱🇰⃞ *Lifeline :* ${anu.message.garis_hidup}`, m)
            }
            break
            case 'keberuntungan': {
                if (!text) throw `Example : ${prefix + command} Dika, 7, 7, 2005`
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Name :* ${anu.message.nama}\n🇱🇰⃞ *Born :* ${anu.message.tgl_lahir}\n🇱🇰⃞ *Results :* ${anu.message.result}`, m)
            }
            break
            case 'memancing': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Date :* ${anu.message.tgl_memancing}\n🇱🇰⃞ *Results :* ${anu.message.result}\n🇱🇰⃞ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Results :* ${anu.message.result}\n🇱🇰⃞ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'zodiak': case 'zodiac': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Zodiac :* ${anu.message.zodiak}\n🇱🇰⃞ *Number :* ${anu.message.nomor_keberuntungan}\n🇱🇰⃞ *Aroma :* ${anu.message.aroma_keberuntungan}\n🇱🇰⃞ *Planet :* ${anu.message.planet_yang_mengitari}\n🇱🇰⃞ *Flower :* ${anu.message.bunga_keberuntungan}\n🇱🇰⃞ *Color :* ${anu.message.warna_keberuntungan}\n🇱🇰⃞ *Stone :* ${anu.message.batu_keberuntungan}\n🇱🇰⃞ *Element :* ${anu.message.elemen_keberuntungan}\n🇱🇰⃞ *Zodiac Couple :* ${anu.message.pasangan_zodiak}\n🇱🇰⃞ *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'shio': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰⃞ *Results :* ${anu.message}`, m)
            }
            break
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply('Your Daily Limit Has Expired')
		    ...
		    db.data.users[m.sender].limit -= 1
                    ...
                    if (anu.status == false) return reply(anu.result.message)
                    GojoMdNx.sendMedia(m.chat, anu.caption.profile_hd, '', `🇱🇰⃞ Full Name : ${anu.caption.full_name}\n🇱🇰⃞ User Name : ${anu.caption.user_name}\n🇱🇰⃞ ID ${anu.caption.user_id}\n🇱🇰⃞ Following : ${anu.caption.followers}\n🇱🇰⃞ Followers : ${anu.caption.following}\n🇱🇰⃞ Bussines : ${anu.caption.bussines}\n🇱🇰⃞ Professional : ${anu.caption.profesional}\n🇱🇰⃞ Verified : ${anu.caption.verified}\n🇱🇰⃞ Private : ${anu.caption.private}\n🇱🇰⃞ Bio : ${anu.caption.biography}\n🇱🇰⃞ Bio Url : ${anu.caption.bio_url}`, m)
		    db.data.users[m.sender].limit -= 1
                } else if (type.toLowerCase() == 'npm') {
                    if (!id) return reply(`No Query username, Example : ${prefix + command} npm scrape-primbon`)
                    let { result: anu } = await fetchJson(api('zenz', '/api/stalker/npm', { query: id }, 'apikey'))
                    if (anu.status == false) return reply(anu.result.message)
                    reply(`🇱🇰⃞ Name : ${anu.name}\n🇱🇰⃞ Version : ${Object.keys(anu.versions)}\n🇱🇰⃞ Created : ${tanggal(anu.time.created)}\n🇱🇰⃞ Modified : ${tanggal(anu.time.modified)}\n🇱🇰⃞ Maintainers :\n ${anu.maintainers.map(v => `- ${v.name} : ${v.email}`).join('\n')}\n\n🇱🇰⃞ Description : ${anu.description}\n🇱🇰⃞ Homepage : ${anu.homepage}\n🇱🇰⃞ Keywords : ${anu.keywords}\n🇱🇰⃞ Author : ${anu.author.name}\n🇱🇰⃞ License : ${anu.license}\n🇱🇰⃞ Readme : ${anu.readme}`)
		    db.data.users[m.sender].limit -= 1
                } else {
		...
		case 'igeh': case 'instagram2x': case 'ig2': case 'igdl2': {
            ...
            case 'joox': case 'jooxdl': {
                ...
                let msg = await GojoMdNx.sendImage(m.chat, anu.result.img, `🇱🇰⃞ Title : ${anu.result.lagu}\n🇱🇰⃞ Album : ${anu.result.album}\n🇱🇰⃞ Singer : ${anu.result.penyanyi}\n🇱🇰⃞ Publish : ${anu.result.publish}\n🇱🇰⃞ Lyrics :\n${anu.result.lirik.result}`, m)
            ...
            case 'soundcloud': case 'scdl': {
                ...
                let msg = await GojoMdNx.sendImage(m.chat, anu.result.thumb, `🇱🇰⃞ Title : ${anu.result.title}\n🇱🇰⃞ Url : ${isUrl(text)[0]}`)
	        ...
	        case 'fbdlx': case 'fbx': case 'facebookx': {
                ...
                GojoMdNx.sendMessage(m.chat, { video: { url: anu.result.url }, caption: `🇱🇰⃞ Title : ${anu.result.title}`}, { quoted: m })
            }
            break
...
`,
		    ...
		    anu.media.map(async (url) => {
		        GojoMdNx.sendMessage(m.chat, { image: { url }, caption: `🇱🇰⃞ Title : ${anu.title}\n🇱🇰⃞ Author : ${anu.author.name}\n🇱🇰⃞ Like : ${anu.like}\n🇱🇰⃞ Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
...
break
                    case 'bug': case 'report': {
                    	...
                    	GojoMdNx.sendMessage(`94729352830@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
And Again Me (King Nexus 🎉) 🇱🇰⃞> Who Helped Assemble This Sexy Script !!!`,unicorn, [{"urlButton": {"displayText": "YouTube📍","url": `${myweb}`}},{"urlButton": {"displayText": "Script🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
